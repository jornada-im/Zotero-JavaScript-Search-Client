...
var ZOTERO_CONFIG = {
   ...
   "collectionKey": "IGTQYDR8", // Key of collection within library to search, e.g., "KHTHLKB5", or "" if no collection
   ...
   "showTags": ["JRN funded", "JRN assisted", "JRN foundational"], // Include a column showing this tag if present for each item
