...
var ZOTERO_CONFIG = {
   "zotId": "4420864", // ID of group or user library to search in Zotero, e.g., 2211939, 2055673
   "zotIdType": "group", // group or user
   "collectionKey": "X43X7IH4", // Key of collection within library to search, e.g., "KHTHLKB5", or "" if no collection
...
function parseZoteroResults(resultText) {
   ...
   function parseType(text) {
      switch (text) {
         ...
         case "document":
            return "Dataset"; // documents in this collection are Datasets //
         case "email":
            return "Email";
         ...
         case "webpage":
            return "Portal"; // websites in this collection are data portals //
         case "note":
            return "Note";
         default:
            return "Other"
